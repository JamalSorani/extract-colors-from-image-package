...
class AssetImageBG extends StatefulWidget {
  ...
  const AssetImageBG(
      {Key? key, required this.assetPath, required this.backgroundColor})
      : super(key: key);
  @override
  AssetImageBGState createState() => AssetImageBGState();
}

class AssetImageBGState extends State<AssetImageBG> {
